> [!CAUTION]
> **本项目已停止维护，不再更新。仅供技术学习交流，严禁用于商业用途或破坏游戏平衡。**
> 由此产生的一切后果由使用者自行承担，与作者无关。
...
- 本项目已停止维护，作者不再提供任何更新或技术支持。
- 仅供个人学习技术交流使用，**严禁用于商业用途或破坏游戏平衡**。
- 使用者应遵守相关法律法规及平台服务条款，因使用本项目产生的一切后果由使用者自行承担，与作者无关。
- 如有侵权请通过 Issue 联系，将及时处理。
